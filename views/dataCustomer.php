...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <li><a href="registerCustomer.php"><i class="fa fa-edit"></i> Registrasi</a></li>
          <li class="active treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Dashboard Admin
        <small>Data Dan Registrasi Customer</small>
      </h1>  
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-footer">
              <i><a href="registerCustomer.php"><button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">Registrasi Customer Baru</button></a></i>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $objcustomer=new modelCustomer();
                  $objcustomer->select();
                  $datacustomer=$objcustomer->getData();
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a type="submit" class="btn btn-social-icon" title="edit"><i class="fa fa-edit" data-toggle="modal" href="#mymodal<?php echo $key['ID_CUSTOMER']; ?> "></i></a> 
                    <a type="submit" class="btn btn-social-icon" title="hapus" href="../proses/prosesCustomer.php?aksi=hapus&hapusidcustomer=<?php echo $key['ID_CUSTOMER'];?>" ><i class="fa fa-trash"></i></a> 
                  </td>
                </tr>


        <div class="modal fade" id="mymodal<?php echo $key['ID_CUSTOMER']; ?>">
          <div class="modal-dialog">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="../proses/prosesCustomer.php?aksi=edit" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="input" class="col-sm-2 control-label">ID Customer</label>
                  <div class="col-sm-10">
                    <input type="input" class="form-control" id="editidcustomer" name="editidcustomer" value="<?php echo $key['ID_CUSTOMER']; ?>">
                  </div>
                  <br></br>
                </div>
