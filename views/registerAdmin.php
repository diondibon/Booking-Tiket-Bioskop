...
<div class="register-box">
  <div class="register-logo">
    <a href="index.php"><b>REGISTRASI admin</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Masukkan Data Dengan Benar</p>

    <form action="../proses/prosesAdmin.php?aksi=tambah" method="post">

      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Id Admin" id="inputidadmin" name="inputidadmin">
